...
```{python}
# Rename columns
table_df = table_df.rename(columns={'2000': 'emissions_2000', '2022': 'emissions_2022'})
table_df
```

```{python}
# Calculate absolute change as the difference between 2022 and 2000
table_df["Relative Change"] = ((table_df["emissions_2022"] - table_df["emissions_2000"]) / table_df["emissions_2000"]) * 100
...
table_df["Absolute Change"] = table_df["emissions_2022"] - table_df["emissions_2000"]
table_df
```
...
countries_of_interest = ["Namibia", "Peru", "Uganda", "Kenya", "Nigeria"]
